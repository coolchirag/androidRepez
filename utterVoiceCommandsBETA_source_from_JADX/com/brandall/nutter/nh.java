...
final class nh extends BroadcastReceiver {
    final /* synthetic */ TaskerPluginActivity f1767a;

    nh(TaskerPluginActivity taskerPluginActivity) {
        this.f1767a = taskerPluginActivity;
    }
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        if (resultExtras.containsKey("android.speech.extra.SUPPORTED_LANGUAGES")) {
            ...
            TaskerPluginActivity.m950a(this.f1767a, arrayList, arrayList2);
        }
    }
}
