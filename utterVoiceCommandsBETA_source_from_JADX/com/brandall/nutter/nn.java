...
final class nn extends BroadcastReceiver {
    final /* synthetic */ WidgetConfiguration f1794a;

    nn(WidgetConfiguration widgetConfiguration) {
        this.f1794a = widgetConfiguration;
    }
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        if (resultExtras.containsKey("android.speech.extra.SUPPORTED_LANGUAGES")) {
            ...
            WidgetConfiguration.m967a(this.f1794a, arrayList, arrayList2);
        }
    }
}
