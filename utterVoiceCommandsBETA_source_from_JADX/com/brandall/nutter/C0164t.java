...
final class C0164t extends BroadcastReceiver {
    final /* synthetic */ ActivityAdvancedSettings f1827a;

    C0164t(ActivityAdvancedSettings activityAdvancedSettings) {
        this.f1827a = activityAdvancedSettings;
    }
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        if (resultExtras.containsKey("android.speech.extra.SUPPORTED_LANGUAGES")) {
            ...
            ActivityAdvancedSettings.m495b(this.f1827a, arrayList, arrayList2);
        }
    }
}
